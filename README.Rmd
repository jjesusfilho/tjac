...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/jjesusfilho/tjac.svg?branch=master)](https://travis-ci.org/jjesusfilho/tjac)
[![AppVeyor buildstatus](https://ci.appveyor.com/api/projects/status/github/jjesusfilho/tjac?branch=master&svg=true)](https://ci.appveyor.com/project/jjesusfilho/tjac)
<!-- badges: end -->
...
Para baixar o html de um ou mais processos de primeiro grau, use a seguinte função:
...
```
Para criar uma tabela com os documentos contidos na movimentação processual:
...
Please note that the 'tjac' project is released with a
